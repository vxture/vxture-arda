...
> 上游：[`biz-100`](arda-biz-100-architecture.md)、[`arda-biz-120-domain-entities-and-feature-keys.md`](arda-biz-120-domain-entities-and-feature-keys.md) §2.4/§3、[`data-240`](arda-data-240-services.md)、[`arda-data-170-platform-agent-support.md`](arda-data-170-platform-agent-support.md)（对外契约）
> 跨切面见 `biz-100` §3
