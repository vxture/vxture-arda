...
|---|---|---|---|
| 回传（原 plat-200）| arda 实施回传：C1/C2/C3/L0 落地方式 + 端点清单 + DB schema + 双方待办 | `arda-plat-200-impl-handoff-2607120135.md` | 完成（v1.1）|
...
> 正文中出现的 `plat-200/210/220/230` 为**概念标签**（对应上表），文件实体在 `docs/70-reply/`。
