...
> 上游：总体设计见 [`data-100`](arda-data-100-architecture.md)；相关横切 `data-130`（加密与密钥）；承载表的板块 schema 见 [`data-250`](arda-data-250-admin.md)（admin 段）；指令通道来源 [ADR](../ADR-entitlement-and-workspace.md) §5.1；对应业务面 [`biz-250`](arda-biz-250-admin.md)；现状交叉 [`data-300`](arda-data-300-migration.md) §4.3
