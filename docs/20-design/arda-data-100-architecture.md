...
> 上游依据：[`ADR-entitlement-and-workspace.md`](../ADR-entitlement-and-workspace.md)（§1.7 SoR 分工、§4 模板、§5 指令、§8 落地清单）、[`domain-entities-and-feature-keys.md`](domain-entities-and-feature-keys.md)（领域实体目录 v1）
