...
[`20-design/arda-biz-100-architecture.md`](../20-design/arda-biz-100-architecture.md).
...
specified in [`20-design/arda-biz-000-index.md`](../20-design/arda-biz-000-index.md).
...
[`ADR-11`](../ADR-11-subscription-entitlement-design.md) and
[`20-design/arda-ent-120-consumption-contract.md`](../20-design/arda-ent-120-consumption-contract.md).
