...
// Integration-status dashboard: at-a-glance view of all platform-integration
// config + live channel probes. Data comes from /api/status (non-secret only);
// channel probes are client-side. Gating (off/authed/public) is enforced by
// /api/status.
...
// ds-allow: bare diagnostic surface (operator/CI tool, not product UI) - no DS
// chrome on purpose, styled inline like the equivalent karda/atlas pages.
const card: React.CSSProperties = {
  border: "1px solid #d0d0d0", // ds-allow: bare diagnostic surface
  borderRadius: 8,
  padding: "12px 16px",
  margin: "0 0 12px",
  maxWidth: 760,
...
const key: React.CSSProperties = { color: "#555" }; // ds-allow: bare diagnostic surface
