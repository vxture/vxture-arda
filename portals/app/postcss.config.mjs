/**
 * PostCSS config for the Arda app.
 *
 ...
 * `--vx-typography-*` / `--font-*` tokens undefined. This does not pull Tailwind
 * utility classes into our markup; it only materializes the DS token layer.
 */
const config = {
  plugins: {
    "@tailwindcss/postcss": {},
